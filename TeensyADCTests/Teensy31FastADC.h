...
/*
FUNCTION PSEUDOCODE FOR MACRO, of course we could not pass value1 and value2 like this to a function!!
...
#define highSpeed8bitAnalogReadMacro(channel,value) ADC0_SC1A = channel; while (!(ADC0_SC1A & ADC_SC1_COCO)) {} value = ADC0_RA;

int highSpeed8bitAnalogRead(uint8_t channel)
{
	ADC0_SC1A = channel;
